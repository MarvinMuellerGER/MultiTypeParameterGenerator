    ...
    public class Create
    {
        ...
        public void Should_ReturnAllAcceptedTypeCombinations()
        {
            ...
            var acceptedTypesForAffectedGenericTypeCollection = new AcceptedTypesForAffectedGenericTypeCollection(
                new(new(new("T1")), new(new(new("bool"), false, false), new(new("string"), false, true))),
                new(new(new("T3")), new(new(new("double"), false, true), new(new("string"), true, true))));
            ...
            var expectedCombinations = new AcceptedTypeCombinationCollection(
                new(
                    new(new(new("T1")), false, new(new("bool"), false, false, 1)),
                    new(new(new("T3")), false, new(new("double"), false, true, 1, 1))),
                new(
                    new(new(new("T1")), false, new(new("bool"), false, false, 1)),
                    new(new(new("T3")), true, new(new("string"), true, true, 1, 1))),
                new(
                    new(new(new("T1")), false, new(new("string"), false, true, 1, 1)),
                    new(new(new("T3")), false, new(new("double"), false, true, 1, 1))),
                new(
                    new(new(new("T1")), false, new(new("string"), false, true, 1, 1)),
                    new(new(new("T3")), true, new(new("string"), true, true, 1, 2))));
